...
def_motherID_fpath="/Users/snaranjo/Desktop/surface-vision-transformers/tools/RESTRICTED_mother_IDs_eid_order.txt"


################################################################################################################
# unrestricted sub-index generator; requires sampling proportion and number of indices (n_dims) in full sample
def generate_subidx_tag(n_dims=1003, sample_prop=0.86):
    num_choices = math.ceil(n_dims * sample_prop)
