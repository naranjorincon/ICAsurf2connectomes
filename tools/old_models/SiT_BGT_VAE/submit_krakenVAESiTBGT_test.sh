#!/bin/bash
#SBATCH -J 4022
#SBATCH -o /ceph/chpc/shared/janine_bijsterbosch_group/naranjorincon_scratch/NeuroTranslate/surf2netmat/batch/te_kvSiTBGT.out%j
#SBATCH -e /ceph/chpc/shared/janine_bijsterbosch_group/naranjorincon_scratch/NeuroTranslate/surf2netmat/batch/te_kvSiTBGT.err%j
...
for yml_file in $(find "$yaml_loc" -type f -name "$condition.yml" -print); do
    ...
    python3 ./SiT_BGT_VAE/krakenloss_VAESiTBGT_test.py "$yml_file"
