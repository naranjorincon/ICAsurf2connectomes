#!/bin/bash
#SBATCH -J 4022
#SBATCH -o /ceph/chpc/shared/janine_bijsterbosch_group/naranjorincon_scratch/NeuroTranslate/surf2netmat/batch/te_kvSiTBGT_outofsample.out%j
#SBATCH -e /ceph/chpc/shared/janine_bijsterbosch_group/naranjorincon_scratch/NeuroTranslate/surf2netmat/batch/te_kvSiTBGT_outofsample.err%j
#SBATCH --partition=tier2_cpu
#SBATCH --account=janine_bijsterbosch
#SBATCH --mem-per-cpu 13G # 10G for base, 6.5G para small
...
yaml_loc="/ceph/chpc/shared/janine_bijsterbosch_group/naranjorincon_scratch/NeuroTranslate/surf2netmat/config/SiT_BGT_VAE/"
...
for yml_file in $(find "$yaml_loc" -type f -name "$condition.yml" -print); do
    ...
    # python3 ./SiT_BGT_VAE/krakenloss_VAESiTBGT_outofsample_test.py "$yml_file"
    python3 ./SiT_BGT_VAE/krakenloss_VAESiTBGT_outofsample_test.py "$yml_file"
